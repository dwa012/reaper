...
public class MediaTypeWrapper {
	...
	private java.util.ArrayList<MediaType> results;

	public MediaTypeWrapper(){
		results = new java.util.ArrayList<MediaType>();
	}

	@JsonProperty("items")
	public java.util.ArrayList<MediaType> getResults() {
		return results;
	}

	@JsonProperty("items")
	public void setResults(java.util.ArrayList<MediaType> results) {
